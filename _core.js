...
// ==================== CONFIG ====================
const GAME_VERSION = '1.66';   // обновлять при каждом релизном срезе (см. AGENTS.md)
const TILE = 24;
...
function showRoadmapPanel(panel) {
  const monthRows = [
    ['done','Неделя 1 — Фундамент','Склад и носильщики, цепочки производства (кузня/кухня), стены+ворота+A*, частицы и береговая линия. ГОТОВО.'],
    ['now', 'Неделя 2 — Контент','Сейчас: боевая глубина (ранен/без сознания), лошади/ранчо, мебель/комнаты, аудио-пасс (эмбиент/музыка), визуал-пасс 2 (анимации, автотайлинг).'],
    ['soon','Неделя 3 — Онлайн-фундамент','Детерминизм + команды, save v2, бэкенд-скелет, облачные сохранения.'],
    ['soon','Неделя 4 — ALPHA','Авторитетный сервер, кооп на двоих по интернету, облачные кооп-сейвы, дизайн глобального мира.'],
    ['soon','После месяца','Глобальный персистентный мир с друзьями, торговля между игроками, аккаунты, релиз.'],
  ];
  const versionRows = [
