...
- Автотесты: `_harness.js`, сценарии A-CG (84) покрывают бой, экономику, save/load, pathfinding, hauling, рецепты, склады/склад-зоны, диагностику, production controls, торговлю, сценарии, мебель/комфорт, комнаты/крыши, ранчо/лошадей, угрозы/огонь, навыки, личность, вес/переноску, зоны, разрешённые зоны, биомы, ресурсы по биомам, воду/дороги, погодное движение, точки интереса, события POI и каркас плавания.
