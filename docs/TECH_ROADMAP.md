...
- Автотесты: `_harness.js`, сценарии A-T уже покрывают бой, экономику, save/load, pathfinding, hauling, рецепты, склады, диагностику, production controls, торговлю, сценарные цели, базовые сценарные события и профили караванов.
...
- [ ] Следующий шаг: UI выбора профиля сделки у торгового поста.
