...
- Текущий `GAME_VERSION`: `1.55`. Наука: tools/medicine/cooking/walls/hunting/trading/marksman.
- Harness: Scenarios A-AS (45) стабильно зелёные. Был флак в AC (RNG-ИИ) — починен пиннингом пешки.
