...
- Последний локальный срез: `v1.41 - Ranch Daily Yield`.
- Базовая игра: `frontier.html`, сборка через `frontier.template.html` + `_core.js`.
- Текущий `GAME_VERSION`: `1.41`.
- Harness: Scenarios A-AG должны быть зелёные; перед push обязательно `node _harness.js`.
...
1. Развитие лошадей/ранчо: приручение, связь с животными, более живой ресурсный цикл.
2. Или мебель и комнаты: проверка комнат, стены жилья, более явные room-бонусы.
