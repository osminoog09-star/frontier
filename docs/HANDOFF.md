...
- Текущий `GAME_VERSION`: `1.48` (Claude: эмбиент 1.45, жильё 1.46, музыка 1.47, анимация работ 1.48).
- Harness: Scenarios A-AM (39) стабильно зелёные. Был флак в AC (RNG-ИИ) — починен пиннингом пешки.
