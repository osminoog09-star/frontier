...
- Текущий `GAME_VERSION`: `1.64`. RimWorld-стройка: полы (v1.63) + стены из материалов (v1.64).
- Harness: Scenarios A-AZ (52) стабильно зелёные. Был флак в AC (RNG-ИИ) — починен пиннингом пешки.
