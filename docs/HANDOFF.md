...
- Текущий `GAME_VERSION`: `1.52`. Оборона: вышка + бочка с порохом (ловушка).
- Harness: Scenarios A-AP (42) стабильно зелёные. Был флак в AC (RNG-ИИ) — починен пиннингом пешки.
