...
- Текущий `GAME_VERSION`: `1.51`. Враги: головорез/стрелок/снайпер/главарь.
- Harness: Scenarios A-AO (41) стабильно зелёные. Был флак в AC (RNG-ИИ) — починен пиннингом пешки.
