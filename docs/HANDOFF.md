...
- Последний локальный срез: `v1.37 - Beds Comfort Slice`.
- Базовая игра: `frontier.html`, сборка через `frontier.template.html` + `_core.js`.
- Текущий `GAME_VERSION`: `1.37`.
- Harness: Scenarios A-AC должны быть зелёные; перед push обязательно `node _harness.js`.
...
1. Мебель и комнаты: столы, красота, бонусы настроения, улучшение комнат.
