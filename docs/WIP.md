...
1. Плотность деревьев/камней/животных по биому.
2. Реки/озёра/дороги как следующий слой читаемой карты.
3. Frontier-точки интереса: руины, лагеря бандитов, прииски.
