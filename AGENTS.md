...
- Внутри «Что будет дальше» помечать прогресс по пунктам: `✅` готовые подпункты и `⏳` оставшиеся
  (например: «✅ анимация работ · ✅ подсветка. ⏳ осталось: автотайлинг»). Полностью готовый пункт — в «Что уже сделано».
